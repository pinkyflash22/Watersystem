...
$email = $_POST['email'];
    ...
    if($getdata){
      echo "<script>alert('METER NUMBER ALREADY EXIST');</script>";
...
$thisday = date("Y-m-d");
        $insertquery = mysqli_query($customercon, "INSERT INTO customerinfo VALUES(null,'$meternum','$lastname','$firstname','$middlename','$house','$street','$barangay','$statusid','$accountid','$contact','$email','$thisday')");
...
<head>
    ...
    <title>UWS-Member-Add-Consumer</title>
...
<div class="row">
    <div class="col" style="display: flex; align-items:center; color: darkslategray;">
       <i class="bi bi-person-rolodex img-fluid fs-1 me-3"></i>MEMBER / ADD CONSUMER
            ...
            <div class="card-title fs-3 fade-in" style="display: flex; align-items:center; color: white;">
                <div class="row  w-100" style=" display:flex; align-items: center;">
                    ...
                    <div class="col text-whire" style=" display:flex;  flex-direction: column;">
                            ...
                            <div class="row fs-6 ps-4">  Create and add consumer information. </div>
            ...
            <div class="col text-wrap mt-4" id="addcol1">
                ...
                $member = mysqli_query($customercon,"SELECT * FROM coveredareas");
                 ?>
                    ...
                    <input type="text" name="house" id="" value="" class="form-control mb-4" required>
                    ...
                    <input type="number" min="9000000000" name="contact" id="" class="form-control mb-4" value="" required>
                     <label for="">Email Address<i style="color: red;">*</i></label>
                    <input type="email" name="email" id="" class="form-control mb-4" value="" >
...
Save</button>
        <a href="mainmember.php" class="btn btn-warning shadow-table" >Cancel</a>

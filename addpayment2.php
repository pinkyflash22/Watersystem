...
<hr style="outline: 1px solid  rgb(225, 242, 246);opacity:100; width: auto;">
    <nav class="d-flex flex-column p-3 mt-4 items">
        ...
        <a href="maindashboard.php" class="mb-4 fs-6"><img src="Team System\dashboard (1).png" class="img-fluid w-25 p-2" alt="">Dashboard</a>
        <a href="" class="mb-4 fs-6"><img src="Team System\dashboard (1).png" class="img-fluid w-25 p-2" alt="">Transaction</a>
                    ...
                    <?php 
                          ...
                          if($queries){
                            ...
                            ?>
                                ...
                                <th scope ="row" class="spaceinside om" style="width: 15%;" id="meter"><?=$info -> billno?></th>
                                <?php 
                                    // if($month == 1){
                                    //     $duedateyear = 
                                    
                                ?>
                                    <td class="spaceinside" style="width: 40%;" id="names"> <?=$info -> period." ".$duedateyear?> </td>
                                    <?php 
                                // }
                                    ?>
                                    <td class="spaceinside" style="width: 25%;"><?=$info -> amount?>
                                   ...
                                   <!-- <button class="editBtn" data-id='' >Edit</button> -->
                                 
                                   <a href="viewpayment.php?customerid=<?=$customid?>&billnum=<?=$info -> billno?>" class="btn btn-warning">View</a>
